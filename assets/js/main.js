(() => {
   ...
   const reponsiveSideBarOverlay = document.querySelector('.responsive-sidebar-menu .sidebar-overlay');
   ...
   const portfolioDetailItems = document.querySelectorAll('.porfolio-detail-item');
